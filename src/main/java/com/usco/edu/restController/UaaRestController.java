...
public class UaaRestController {
	...
	@GetMapping("/uaa/findSedesRestaurante/{username}")
	public List<Dependencia> findSedesRestaurante(@PathVariable("username") String userdb) {
		return uaaService.findSedesRestaurante(userdb);
	}
	...
	/*
	 * @GetMapping("/uaa/findById/{username}/{uaacodigo}") public List<Uaa>
	 * findById(@PathVariable("username") String userdb,@PathVariable("uaacodigo")
	 * int UaaCodigo){ List<Uaa> uaa = new ArrayList<Uaa>();
	 * uaa.add(uaaService.findById(userdb, UaaCodigo)); return uaa; }
	 */
